<div class="card h-100 market-product-card">
    ...
    <div class="card-body">
        ...
        <a href="{{ route('product.show', $product) }}" class="btn btn-outline-info d-block"><i class="fas fa-shield-alt mr-2"></i>View protected offer</a>
    </div>
</div>
